  ...
  Future<void> seedInitialDataIfEmpty() async {
    ...
    final sampleSchools = [
      SchoolModel(
        ...
        established: 1926,
        description: 'Premier national secondary school in Kenya with rich academic excellence.',
      ),
      SchoolModel(
        id: 'school_st_mary',
        ...
        students: 820,
        motto: 'Truth, Wisdom and Character',
        principal: 'Mrs. Elizabeth Mensah',
        phone: '+233 24 123 4567',
        email: 'admissions@stmarys-gh.com',
        established: 1995,
        description: 'Leading international curriculum school located in Accra, Ghana.',
      ),
      SchoolModel(
        id: 'school_kigali_innov',
        name: 'Kigali Innovation High',
        location: 'Kigali, Rwanda',
        type: 'Secondary',
        students: 650,
        motto: 'Innovate and Transform',
        principal: 'Dr. Jean-Paul Habimana',
        phone: '+250 788 987 654',
        email: 'contact@kigali-innov.rw',
        established: 2018,
        description: 'STEM-focused center of excellence nurturing young African innovators.',
      ),
    ];
